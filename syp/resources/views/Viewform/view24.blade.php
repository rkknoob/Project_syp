    ...
    <div class="container">
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td>1. ทราบถึงขั้นตอนในการส่ง Progress report</td>
                ...
                <tr>
                    ...
                    <td>2.ปฎิบัติงาน ด้วยความรอบคอบ และมั่นใจก่อนส่ง Report Daily</td>
                </tr>
                <tr>
                    <td>3. ทราบวิธีการแก้ไขปัญหาหน้างาน และแจ้งให้หัวหน้าทราบถึงปัญหา</td>
                    <td>3. ต้องตรวจความถูกต้อง ก่อนส่ง Report</td>
                </tr>
                <tr>
                    <td></td>
                    <td>4.แจ้งให้หัสหน้าทราบทันที หากพบปัญหาในระหว่างการปฎิบัติงาน</td>
                </tr>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td align="center">...</td>
                    <td align="center">หากพบปัญหาให้แจ้งหัวหน้างานหน่วยงานที่เกี่ยวข้องทราบถึงปัญหา และตรวจสอบให้ถี่ถ้วนก่อนส่ง Report</td>
