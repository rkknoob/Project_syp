        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class = 'div_text'>
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><b>Performance Development Form – Over Break</b></td>
                    ...
                    <tr>
                        <td><b> แผนพัฒนาสำหรับ - การตรงต่อเวลาพัก</b></td>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td>2. ทราบช่วงเวลาพักเบรค ของแต่ละกะ ได้อย่างถูกต้อง</td>
                    <td>2. ตรงต่อเวลาทุกครั้งในการปฏิบัติงาน</td>
                </tr>
                <tr>
                    <td>3. ทราบถึงผลกระทบในการพักเกินเวลา ต่อเพื่อนพนักงานและงานที่ตนรับผิดชอบ </td>
                    <td>3.ต้องพักเบรค ตรงตามเวลาที่บริษัทกำหนดไว้</td>
                </tr>
                <tr>
                    <td>4. ทราบบทลงโทษทางวินัยที่ต้องได้รับ หากไม่ปฏิบัติตามระเบียบปฏิบัติ</td>
                    <td></td>
                </tr>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td align="center">พนักงานพักเบรคเกินเวลาที่บริษัทกำหนด</td>
                    <td align="center">พนักงานต้องปฎิบัติตามกฏระเบียบ
                        ของบริษัท
                    </td>
