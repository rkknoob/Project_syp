                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="hidden" class="form-control" name="user_code2" id="user_code2" value="{{$input}}" maxlength ="8">
                        </div>
                        <div class="col-md-2">
            ...
            <div class="panel panel-danger " >
                <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class ="col-md-2">
                                <label for="depart_no" class="control-label">แผนก/หน่วยงาน :</label>
                            ...
                            <div class ="col-md-3">
                                <label for="depart_no" class="control-label">วันที่เริ่มงาน :{{$data_user2->work_dat}}</label>
                                @foreach($time_working as $time_working2)
                                    <label for="depart_no" class="control-label"></label>
                                @endforeach
                            </div>
                            <div class ="col-md-3">
                            ...
                            @foreach($res as $results2)
                                ...
                                >
                                    ...
                                    @if($results2->D1 == '1')
                                        ...
                                        <?php
                                        $test = '1'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D1}}</a></td>
                                ...
                                >
                                    ...
                                    @if($results2->D2 == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '2'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D2}}</a></td>                                @elseif($results2->D2 == '0')
                                ...
                                >
                                    ...
                                    @if($results2->D3 == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '3'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D3}}</a></td>                                @elseif($results2->D3 == '0')
                                ...
                                >
                                    ...
                                    @if($results2->D4 == '1')
                                        ...
                                        <?php
                                        $test = '4'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D4}}</a></td>
                                ...
                                >
                                    ...
                                    @if($results2->D5 == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '5'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D5}}</a></td>                                @elseif($results2->D2 == '0')
                                ...
                                >
                                    ...
                                    @if($results2->D6 == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '6'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D6}}</a></td>                                @elseif($results2->D2 == '0')
                                ...
                                >
                                    ...
                                    @if($results2->D7 == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '7'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D7}}</a></td>                                @elseif($results2->D5 == '0')
                                ...
                                >
                                    ...
                                    @if($results2->D8 == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '8'; ?>
                                        <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->D8}}</a></td>                                @elseif($results2->D5 == '0')
                                ...
                                >
                                    ...
                                    @if($results2->V == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '9'; ?>
                                            <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->V}}</a></td>                                @elseif($results2->V == '0')
                                ...
                                >
                                    ...
                                    @if($results2->W == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '10'; ?>
                                            <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->W}}</a></td>                                @elseif($results2->W == '0')
                                ...
                                >
                                    ...
                                    @if($results2->TM == '1' && $results2->Desc1 !== "Summary")
                                        ...
                                        <?php
                                        $test = '11'; ?>
                                            <a href="{{url('/test/pdf/admin',$results2->Desc1)}}/{{$test}}/{{$input}}" target="_blank"> {{$results2->TM}}</a></td>                                @elseif($results2->TM == '0')
                                ...
                                <td> @if(($results2->last_day == '0' && $results2->Desc1 == "Summary") )
                                    ...
                                    @elseif (($results2->last_day == '1' && $results2->Desc1 == "Summary") )
                                        {{''}}
                                ...
                                <td>@if($results2->Day_Now == '0' && $results2->Desc1 == "Summary" )
                                    ...
                                    @elseif (($results2->Day_Now == '1' && $results2->Desc1 == "Summary") )
                                        {{''}}
...
@section('javascript')
    ...
    <script>
        ...
        jQuery(function ($) {
            ...
            $("input[name$='un_start']").mask('99:99');
