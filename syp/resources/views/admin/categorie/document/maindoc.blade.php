            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-6">
                                <a class="btn btn-success" href="{{Route('admin/categorie/document.newdata')}}" role="button"><i class="fa fa-fw fa-plus-circle"></i> เพิ่มข้อมูล</a>
                            ...
                            <div class="col-sm-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0"  rowspan="1" colspan="1" style="width: 100px;">เลขที่เก็บ</th>
                                    ...
                                    @foreach($show_document as $show_document2)
                                        <tr data-tr="{{$show_document2->id}}">
                                            ...
                                            <td>{{$show_document2->user_code}}</td>
                                            <td>{{$show_document2->filename}}</td>
                                            <td>{{$show_document2->name}}</td>


                                            <td>
                                                <a class="btn btn-info btn-xs" target="_blank" href="http://203.151.93.196:8080/uploads/{{$show_document2->filename}}" role="button"><i class="fa fa-fw  fa-file-text"></i> ไฟล์เอกสาร</a>
