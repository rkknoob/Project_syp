...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td><div class="font_textb">Performance Development Form – Receiving Accuracy</div></td>
    ...
    <tr>
        <td ><div class="font_textb">แผนพัฒนาสำหรับ ความถูกต้องของการรับสินค้า</div></td>
...
<table  align="center"  width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td>1. ทราบถึงขั้นตอนในการทำงานของหน้าที่ Receiving ได้อย่างถูกต้อง</td>
        <td>1. ปฏิบัติตามขั้นตอนการปฏิบัติงาน ได้อย่างถูกต้อง</td>

    </tr>
    <tr>
        <td>2. ต้องผ่านการอบรม การใช้หน้าจอ RF เรื่องหน้าที่ในการรับสินค้าได้อย่างถูกต้อง</td>
        <td>2. ปฏิบัติงาน ด้วยความรอบคอบ</td>
    </tr>
    <tr>
        <td>3. ทราบถึงผลกระทบของการปฏิบัติงานรับสินค้าที่ผิดพลาด </td>
        <td>3. ตั้งใจปฏิบัติหน้าที่การรับสินค้า ได้อย่างถูกต้อง</td>
    </tr>
    <tr>
