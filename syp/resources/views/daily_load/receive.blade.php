...
@section('content')
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">รายการ Receive</li>
        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="GET" action="">
            ...
            <div class="panel panel-primary" >
                <div class="panel-heading">
                    <h4> <i class="fa fa-eercast"></i>รายการ Receive</h4>
                </div>
                <div class="table-responsive">
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            @foreach($data_receive as $data_receive2)
                                <tr data-tr="{{$data_receive2->trin}}">

                                    <td>{{ \Carbon\Carbon::parse($data_receive2->day_upload)->format('d/m/Y')}}</td>
                                    <td>{{$data_receive2->trin}}</td>
                                    <td>{{$data_receive2->trailer_no}}</td>
                                    <td>{{$data_receive2->time_trunk}}</td>
                                    ...
                                    <th>
                                        ...
                                        <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#myModal" onclick="att_data('<?php echo $data_receive2->trin;?>')">Unload</button>
...
@section('javascript')
    ...
    <script>
        ...
        function save_data() {
            ...
            $.ajax({
                type: 'get',
                url:  '/daily_load/index/receive/update/',
                ...
                success: function( msg ) {
                    ...
                    if(msg.trim()=='1'){
                        ...
                        setTimeout(function(){  window.location = '{{route('daily_load.receive')}}'; }, 1000);
                        ...
                        setTimeout(function(){  window.location = '{{route('daily_load.receive')}}'; }, 2000);
                    }
