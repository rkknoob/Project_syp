...
@section('content')
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Upload Daily Load Plan</li>
        </ul>
    </div><!-- breadcrumb -->
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-success ">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('route' => 'import-csv-excel/plan_daily','method'=>'POST','files'=>'true' ,'class'=>'form-horizontal','id'=>"formupload",'name'=>"formupload,'onClick' => 'submitForm()'"  ))   !!}
                        {!! csrf_field() !!}
