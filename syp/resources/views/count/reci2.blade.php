...
@section('content')
    ...
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Count คืน 2</li>
        </ul>
    </div><!-- breadcrumb -->
    <br>
        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint">
            ...
            <div class="panel panel-danger " >
                <div class="panel-heading">
                    <h4> <i class="fa fa-search " ></i> คืน Count Sheet รอบ 2</h4>
                </div>
                @include('sweet::alert')
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="location" id="location" value="{{ old('id') }}" maxlength ="7"onKeyUp="setNextFocus(this,'user_code');">
                        </div>
