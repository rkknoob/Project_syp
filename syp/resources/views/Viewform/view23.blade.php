        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class = 'div_text'>
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><b>Performance Development Form – Inventory Accuracy</b></td>
                    ...
                    <tr>
                        <td><b> แผนพัฒนาสำหรับ Inv.ความถูกต้องในการทำงาน</b></td>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td align="center">พนักงาน Adjust Code 99 ไม่ Balance</td>
                    <td align="center">พนักงานต้องทำงานRecheck Code Adjust ก่อนจบกะทุกครั้ง</td>
                    <td align="center">ทันที</td>
                    <td align="center">...</td>
                    <td align="center">พนักงานรับทราบพร้อมปฎิบัติ</td>
                </tr>
                <tr>
                    <td align="center">...</td>
                    <td align="center">...</td>
