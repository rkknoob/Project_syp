...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td><div class="font_textb">Performance Development Form – PE</div></td>
    ...
    <tr>
        <td ><div class="font_textb">แผนพัฒนาสำหรับ การตรวจสอบรถ PE ให้อยู่ในสภาพพร้อมใช้งาน</div></td>
...
<table  align="center"  width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td>1. ผ่านการอบรมเรื่อง "การตรวจเช็ค PE ก่อนนำไปใช้ปฏิบัติงาน</td>
        <td>1.ต้องปฏิบัติงานตามระเบียบ ขั้นตอนการปฏิบัติงาน ที่บริษัทกำหนดไว้</td>

    </tr>
    <tr>
        <td>2. ต้องเข้าใจเอกสาร "การตรวจเช็ค PE  ก่อนนำไปใช้งานได้อย่างถูกต้อง</td>
        <td>2. ตรวจเช็ค MHE ทุกครั้งก่อนนำไปใช้ปฏิบัติงาน</td>
    </tr>
    <tr>
        <td>3. ทราบถึงวิธีการแจ้งซ่อม เมื่อพบข้อบกพร่องในการตรวจเช็ค MHE ได้อย่างถูกต้อง</td>
        <td>3. หากพบอุปกรณ์ชำรุด ต้องแจ้งหน่วยงานที่เกี่ยวข้องทราบและห้ามนำไปใช้งานโดยเด็ดขาด</td>
    </tr>
    <tr>
        <td>4. ผ่านการอบรมการใช้อุปกรณ์ MHE และได้รับอนุญาติให้ใช้งาน</td>
        <td>4. นำอุปกรณ์ที่ผ่านการตรวจสอบ ไปใช้งานด้วยความระมัดระวัง</td>
    </tr>
