...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td><div class="font_textb">Performance Development Form  :JA Compliance</div></td>
    ...
    <tr>
        <td ><div class="font_textb">แผนพัฒนาสำหรับ การสแกน JA ให้ครบทุกขั้นตอน</div></td>
...
<table  align="center"  width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td>2. ทราบขั้นตอนการสแกน JA อย่างถูกต้อง</td>
        <td>2. พนักงานต้องสแกน JA ให้ครบทุกขั้นตอน</td>
    </tr>
    <tr>
        <td>3. ทราบความผิดปกติของเครื่องสแกนที่ทำให้เกิดการสแกนไม่ติด</td>
        <td>3. ต้อง Scan JA ด้วยความระมัดระวัง </td>
    </tr>
    <tr>
        <td>4. ทราบถึงผลกระทบในการสแกนบัตร JA ไม่ครบ</td>
        <td>4. ทราบถึงความสำคัญของการสแกน JA ที่มีผลต่อ performance ของตนเอง</td>
    </tr>
    <tr>
        <td>5. สามารถเข้าใจและผ่านการอบรมหน้าจอ MK500 หรือเครื่องสแกน </td>
        <td>5. ต้องตรวจสอบหน้าจอ MK500 ทุกครั้ง หลัง Scan JA อย่างสม่ำเสมอ</td>
    </tr>
...
<table width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td align="center">พนักงานไม่ได้ SCAN Outday</td>
        <td align="center">พนักงานต้อง SCAN JA ให้ครบทุกขั้นตอน</td>
