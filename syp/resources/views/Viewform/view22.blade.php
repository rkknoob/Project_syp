        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class = 'div_text'>
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><b>Performance Development Form – Report Accuracy</b></td>
                    ...
                    <tr>
                        <td><b> แผนพัฒนาสำหรับ ความถูกต้องของการทำงาน</b></td>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td align="center">ทำ Progress Report ผิดพลาด</td>
                    <td align="center">ให้ตรวจสอบ Report ก่อนส่งทุกครั้ง</td>
