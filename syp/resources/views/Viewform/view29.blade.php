        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class = 'div_text'>
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><b>Performance Development Form</b></td>
                    ...
                    <tr>
                        <td><b>ข้อห้ามปฏิบัติสำหรับศูนย์กระจายสินค้าว่าด้วยเรื่องสุขภาพและความปลอดภัย</b></td>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td>1. สวมใส่หมวกกันน็อคขณะขับรถจักรยานยนต์เดินทางมาปฏิบัติงานในศูนย์กรายสินค้า</td>
                    <td>1.ต้องสวมใส่หมวกกันน็อคทุกครั้งก่อนเดินทางมาปฏิบัติงานในศูนย์กระจายสินค้า</td>

                </tr>
                <tr>
                    <td>2. คาดหรือรัดเข็มขัดนิรภัยขณะรถยนต์ทุกครั้ง</td>
                    <td>2.ต้องคาดเข็มขัดนิรภัยทุกครั้งที่ขับขี่หรือโดยสารรถยนต์</td>
                </tr>
                <tr>
                    <td>3. ผ่านการอบรมเพื่อออกใบอนุญาตขับขี่รถจักรยานยนต์และรถยนต์</td>
                    <td>3.ต้องปฏิบัติตามกฏระเบียบด้านความปลอดภัยอย่างเคร่งครัด</td>
                </tr>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td align="center">พนักงานไม่ปฏิบัติตามกฏความปลอดภัย ไม่สวมหมวกกันน็อดขณะขับขี่รถจักรยานยนต์ในขณะมาปฏิบัติงานใน DC ขอนแก่น</td>
                    <td align="center">...</td>
                    <td align="center">...</td>
                    <td align="center">...</td>
                    <td align="center">...</td>
