...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td><div class="font_textb">Performance Development Form – Shipping Accuracy</div></td>
    ...
    <tr>
        <td ><div class="font_textb">แผนพัฒนาสำหรับ การทำงานโหลดตู้สินค้าในเวลาที่กำหนด</div></td>
...
<table  align="center"  width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td>1. ทราบถึงขั้นตอนในการทำงานของหน้าที่ Shipping ได้อย่างถูกต้อง</td>
        <td>1. ปฏิบัติตามขั้นตอนการปฏิบัติงาน ได้อย่างถูกต้อง</td>

    </tr>
    <tr>
        <td>2. ต้องผ่านการอบรม การใช้หน้าจอ RF เรื่องหน้าที่ในการ Ship สินค้าได้อย่างถูกต้อง</td>
        <td>2. ปฏิบัติงาน ด้วยความรอบคอบ </td>
    </tr>
    <tr>
        <td>3. ทราบถึงผลกระทบของการปฏิบัติงาน Ship สินค้าที่ผิดพลาด </td>
        <td>3. ตั้งใจปฏิบัติหน้าที่การ  Ship สินค้า ได้อย่างถูกต้อง</td>
    </tr>
    <tr>
        <td>4. บทลงโทษทางวินัยที่ต้องได้รับ หากไม่ปฏิบัติตามขั้นตอนการทำงานที่ถูกต้อง</td>
        <td>4. แจ้งหัวหน้าทราบทันที หากพบปัญหาในระหว่างการปฏิบัติงาน</td>
    </tr>
    <tr>
        <td>5. ทราบวิธีการแก้ไขปัญหาหน้างาน และแจ้งให้หัวหน้างานทราบถึงปัญหาทันที</td>
        <td>5.ปฏิบัติงานให้แล้วเสร็จภายในระยะเวลาที่กำหนด ( KPI และ เวลา F9 )</td>
    </tr>
