                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('fname') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">fname</label>
                            ...
                            <div class="form-group{{ $errors->has('lname') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">lname</label>
                            ...
                            <div class="form-group{{ $errors->has('user_code') ? ' has-error' : '' }}">
                                <label for="user_code" class="col-md-4 control-label">user_code</label>

                                <div class="col-md-6">
                                    <input id="user_code" type="text" class="form-control" name="user_code" value="{{ old('user_code') }}" required>
