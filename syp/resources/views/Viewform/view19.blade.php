        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class = 'div_text'>
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><b>Performance Development Form – Code 55</b></td>
                    ...
                    <tr>
                        <td><b>แผนพัฒนาสำหรับ ความถูกต้องของการเบิกสินค้า</b></td>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td>1. ทราบถึงขั้นตอนในการทำงานของหน้าที่ Unit / Case pick</td>
                    <td>1. ปฎิบัติตามขั้นตอนการปฎิบัติงาน ได้อย่างถูกต้อง</td>

                </tr>
                <tr>
                    <td>2. ต้องผ่านการอบรม การใช้หน้าจอ RF ได้อย่างถูกต้อง</td>
                    <td>2. ปฎิบัติงาน ด้วยความรอบคอม</td>
                </tr>
                <tr>
                    <td>3. เข้าใจขั้นตอนในการเบิกสินค้าห้าม Confirm เกินของที่มีอยู่จริงใน location prime</td>
                    <td>3. ห้าม Confirm เกินของที่มีอยู่จริงใน location prime</td>
                </tr>
                <tr>
                    <td>4. ทราบถึงผลกระทบของการปฎิบัติงาน Unit / Case pick ที่ไม่ถูกต้อง</td>
                    <td>4. ในการปฎิบัติงานในหน้าที่ Unit / Case pick</td>
                </tr>
                <tr>
                    <td>5. ทราบบทลงโทษทางวินัยที่ต้องได้รับ หากไม่ปฎิบัติตามขั้นตอนการทำงาน</td>
                    <td>5. ตั้งใจปฎิบัติงานในหน้าที่ Unit / Case pick</td>
                </tr>

                <tr>
                    <td>6. ทราบวิธีการแก้ไขปัญหาหน้างาน และแจ้งให้หัวหน้างานทราบถึงปัญหาทันที</td>
                    <td>6. แจ้งหัวหน้าทราบทันที หากพบปัญหาในระหว่างการปฎิบัติงาน</td>
                </tr>
