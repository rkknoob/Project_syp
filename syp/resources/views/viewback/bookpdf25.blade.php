...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td><div class="font_textb">Performance Development Form – Confirm Location</div></td>
...
<table  align="center"  width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td>1. ทราบถึงขั้นตอนในการทำงานของหน้าที่ Confirm Location หลังจากเบิกสินค้าได้อย่างถูกต้อง</td>
        <td>1. ปฎิบัติงาน ด้วยความรอบคอม</td>

    </tr>
    <tr>
        <td>2. ผ่านการอบรม การใช้หน้าจอ RF เรื่องหน้าที่ในการรับสินค้าได้อย่างถูกต้อง</td>
        <td>2. ปฏิบัติงาน ด้วยความรอบคอม</td>
    </tr>
    <tr>
        <td>3. ทราบถึงผลกระทบของการปฎิบัติที่ลืม Confirm Location หรือ กด Confirm location โดยไม่ได้ยิง Bar Code ที่หน้าประตู</td>
        <td>3. ตั้งใจปฎิบัติหน้าที่การเบิกสินค้า ได้อย่างถูกต้อง</td>
    </tr>
    <tr>
        <td>4. บทลงโทษทางวินัยที่ต้องได้รับ หากไม่ปฎิบัติตามขั้นตอนการทำงานที่ถูกต้อง</td>
        <td>4. แจ้งหัวหน้าทราบทันที หากพบปัญหาในระหว่างการปฎิบัติงาน</td>
    </tr>
    <tr>
        <td>5. ทราบวิธีการแก้ไขปัญหาหน้างาน และแจ้งให้หัวหน้างานทราบถึงปัญหาทันที</td>
        <td>5. Confirm location โดยการยิง Bar code ที่หน้าประตูเท่านั้น</td>
    </tr>

    <tr>
        <td></td>
        <td>6.ห้าม Confirm location โดยการกดเองใน RF</td>
    </tr>
...
<table width="100%" cellpadding="0" cellspacing="0" class="table_dd">
    ...
    <tr>
        <td align="center">ปฎิบัติตามขั้นตอนการทำงานให้ถูกต้อง</td>
        <td align="center">คอนเฟริมประตูสินค้าในระบบให้ถูกต้อง</td>
