        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class = 'div_text'>
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><b>Performance Development Form – Performance</b></td>
            ...
            <table border="1" align="center" width="80%">
                ...
                <tr>
                    <td>1. ทราบถึงขั้นตอนในการบันทึกข้อมูลตะกร้าได้อย่างถูกต้อง</td>
                    <td>1. ปฎิบัติตามขั้นตอนการปฎิบัติงาน ได้อย่างถูกต้อง</td>

                </tr>
                <tr>
                    <td>2. ทราบถึงผลกระทบจากการบันทึกข้อมูลอุปกรณ์ที่ผิดพลาด</td>
                    <td>2. ต้องบันทึกข้อมูลใน RF ได้อย่างถูกต้องและครบถ้วน</td>
                </tr>
                <tr>
                    <td>3. บทลงโทษทางวินัยที่ต้องได้รับ หากไม่ปฎิบัติตามขั้นตอนการทำงานที่ถูกต้อง</td>
                    <td>3. เข้าใจและใช้ตะกร้าติด Tag สำหรับการ Pick สินค้าประเภท Unit ได้อย่างถูกต้อง</td>
                </tr>
                <tr>
                    <td>4. ทราบวิธีการแก้ไขปัญหาหน้างาน และแจ้งให้หัวหน้างานทราบถึงปัญหาทันที</td>
                    <td>4. บันทึกข้อมูล เข้า และ ออก ตามจำนวนตะกร้าเข้า และออก ตามข้อมูลจริง</td>
                </tr>
                <tr>
                    <td>5. ทราบถึงผลกระทบจากการบันทึกข้อมูลในTCRเพื่อไม่ให้เกิดความผิดพลาดในการจ่ายอุปกรณ์</td>
                    <td>5. แจ้งหัวหน้าทราบทันที หากพบปัญหาในระหว่างการปฎิบัติงาน</td>
                </tr>
