...
@section('content')
    ...
    <br>
    <div class="container">
        <form class="form-horizontal form-border no-margin"  autocomplete="off" name="type-constraint" id="type-constraint" method="POST" onsubmit="return validateForm()" enctype="multipart/form-data" action="{{route('devo.create')}}" >
            {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class ="col-md-3">
                                ...
                                @foreach($time_working as $time_working2)
                                    <label for="depart_no" class="control-label">{{$data_user2->work_dat}}</label>
                                @endforeach
                            </div>
                            <div class ="col-md-3">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><label class="fa fa-warning fa-lg"></label> ประวัติการสอนงาน </h4>
                </div>
