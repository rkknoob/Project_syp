        ...
        <form class="form-horizontal form-border no-margin"  id="type-constraint" method="GET" action="">
            ...
            <div class="panel panel-primary " >
                <div class="panel-heading">
                    <h4> <i class="fa fa-search " ></i> ค้นหาแผนก</h4>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="depart_no" class="col-md-2 control-label">เลือกแผนก: </label>
                        <div class="col-md-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($work_daily as $work_daily2)
                                <tr data-tr="{{$work_daily2->id}}">
                                    ...
                                    @if($work_daily2->upload_pdf == null)
                                        <th>
                                            <button type="button" class="show-modal btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-id="{{$work_daily2->id}}" data-title="{{$work_daily2->user_code}}" data-content="{{$work_daily2->detail}}" data-mistake_code="{{$work_daily2->mistake_code}}:{{$work_daily2->description_mistake}}"  data-pdf="{{$work_daily2->upload_pdf}}"><span class="glyphicon glyphicon-eye-open"></span></button>
                                    ...
                                    @else
                                        <th>
                                            ...
                                            <a class="btn btn-info btn-xs" target="_blank" href="http://203.151.93.196:8080/uploads/{{$work_daily2->upload_pdf}}" role="button">PDF</a>
                                            <button type="button" class="show-modal btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-id="{{$work_daily2->id}}" data-title="{{$work_daily2->user_code}}" data-content="{{$work_daily2->detail}}" data-mistake_code="{{$work_daily2->mistake_code}}:{{$work_daily2->description_mistake}}"  data-pdf="{{$work_daily2->upload_pdf}}"><span class="glyphicon glyphicon-eye-open"></span></button>
                                            <a href="{{ route('workdaily.create', [$work_daily2->user_code, $work_daily2->mistake_code, $work_daily2->id]) }}" class="btn btn-primary btn-xs">
                                                เลือก
                                            </a>
